        ...
        {({ open }) => (
          <>
            ...
            <div className="mt-1 relative">
              <Listbox.Button className="relative w-full bg-black border border-gray-700 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-pink-500 focus:border-pink-500 sm:text-sm">
                ...
                >
                  {options.map((option) => (
                    <Listbox.Option
                      ...
                      className={({ active }) =>
                        classNames(
                          active ? "text-white bg-pink-600" : "text-gray-100",
                      ...
                      {({ selected, active }) => (
                        <>
                          ...
                          {selected ? (
                            <span
                              className={classNames(
                                active ? "text-black" : "text-pink-600",
